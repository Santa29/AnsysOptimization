...
# Create Named Selection Group
primarySelection = FaceSelection.Create([GetRootPart().Bodies[3].Faces[3],
    GetRootPart().Bodies[3].Faces[2],
    GetRootPart().Bodies[4].Faces[1],
    GetRootPart().Bodies[4].Faces[0],
    GetRootPart().Bodies[3].Faces[0],
...
# Create Named Selection Group
primarySelection = BodySelection.Create(GetRootPart().Bodies[2])
secondarySelection = Selection.Empty()
result = NamedSelection.Create(primarySelection, secondarySelection)
# EndBlock
...
# Сохранить проект: C:\Ansys projects\Lopast_helicopter\Lopast_helicopter_files\dp0\Geom-3\DM\Geom-3.scdoc
options = ExportOptions.Create()
DocumentSave.Execute(r"C:\Ansys projects\Lopast_helicopter\Lopast_helicopter_files\dp0\Geom-3\DM\Geom-3.scdoc", options)
# EndBlock