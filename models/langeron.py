...
from models.my_orm import LangeronTable
...
class LangeronModel:
    ...
    def __repr__(self):
        info: str = f'Оболочка [Ланжерон Серия - {self.series} Имя - {self.model_name}, Создан - {self.creation_time}]'
        return info
    ...
    def update_values(self):
        ...
        LangeronTable.objects.update(data_to_update)
